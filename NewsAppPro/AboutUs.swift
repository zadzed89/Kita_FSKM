...
class AboutUs: UIViewController,UIWebViewDelegate
{
    ...
    func getAboutUsData(_ requesturl: String?)
    {
        ...
        print("About Us API URL : \(strDict)")
        ...
        { task, responseObject in if let responseObject = responseObject
            {
                print("About Us Responce Data : \(responseObject)")
    ...
    func setDataIntoScrollView()
    {
        ...
        self.imglogo?.sd_setImage(with: url, completed: nil)
    ...
    {
        print("Webview webViewDidStartLoad")
    }
