...
class Top10ViewNews: UIViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,GADBannerViewDelegate,GADInterstitialDelegate
{
    ...
    var MostViewsArray = NSMutableArray()
    ...
    override func viewDidLoad()
    {
        ...
        //======Get Most Viewed News Data======//
        self.myTableView?.isHidden = true
        self.getMostViewedNews()
    }
    ...
    func getMostViewedNewsData(_ requesturl: String?)
    {
        ...
        { task, responseObject in if let responseObject = responseObject
            {
                print("Most Viewed News Responce Data : \(responseObject)")
                self.MostViewsArray.removeAllObjects()
                ...
                for i in 0..<storeArr.count {
                    ...
                    if (storeDict != nil) {
                        self.MostViewsArray.add(storeDict as Any)
                    }
                }
                print("MostViewsArray Count = \(self.MostViewsArray.count)")
                
                DispatchQueue.main.async {
                    if (self.MostViewsArray.count == 0) {
                        self.myTableView?.isHidden = true
    ...
    {
        return self.MostViewsArray.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let newsType : String? = (self.MostViewsArray.value(forKey: "news_type") as! NSArray).object(at: indexPath.section) as? String
        if (newsType == "video") {
            let videoID : String? = (self.MostViewsArray.value(forKey: "video_id") as! NSArray).object(at: indexPath.section) as? String
            strImgPath = String(format: "http://i3.ytimg.com/vi/%@/hqdefault.jpg", videoID!)
            cell.btnPlay?.isHidden = false
        } else {
            strImgPath = (self.MostViewsArray.value(forKey: "news_image_b") as! NSArray).object(at: indexPath.section) as? String
        ...
        cell.lblNewsTitle?.text = (self.MostViewsArray.value(forKey: "news_title") as! NSArray).object(at: indexPath.section) as? String
        cell.lblDate?.text = (self.MostViewsArray.value(forKey: "news_date") as! NSArray).object(at: indexPath.section) as? String
        cell.lblViews?.text = (self.MostViewsArray.value(forKey: "news_views") as! NSArray).object(at: indexPath.section) as? String
        ...
        DispatchQueue.main.async {
            let htmlDesc = (self.MostViewsArray.value(forKey: "news_description") as! NSArray).object(at: indexPath.section) as? String
        ...
        modalObj.id = ((self.MostViewsArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let newsID : String = ((self.MostViewsArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let video_id : String = ((self.MostViewsArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let modalObj: Modal = Modal()
        modalObj.id = ((self.MostViewsArray.value(forKey: "id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cid = ((self.MostViewsArray.value(forKey: "cid") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.category_name = ((self.MostViewsArray.value(forKey: "category_name") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cat_id = ((self.MostViewsArray.value(forKey: "cat_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_type = ((self.MostViewsArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_title  = ((self.MostViewsArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_url = ((self.MostViewsArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_id = ((self.MostViewsArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_b = ((self.MostViewsArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_s = ((self.MostViewsArray.value(forKey: "news_image_s") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_description = ((self.MostViewsArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_date = ((self.MostViewsArray.value(forKey: "news_date") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_views = ((self.MostViewsArray.value(forKey: "news_views") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let news_title = (self.MostViewsArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!)
        let news_image_b = (self.MostViewsArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!)
        let news_description = (self.MostViewsArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!)
        let news_type : String = (self.MostViewsArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as! String
        let video_id = (self.MostViewsArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!)
        let video_url = (self.MostViewsArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!)
    ...
    override func viewDidLayoutSubviews()
    {
        ...
        //4.Header Name
        self.lblheadername?.text = CommonMessage.MostViewed()
