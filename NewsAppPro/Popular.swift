...
class Popular: UIViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,GADBannerViewDelegate,GADInterstitialDelegate
{
    ...
    func getPopularNews()
    {
        if (Reachability.shared.isConnectedToNetwork()) {
            ...
            self.getPopularNewsData(encodedString)
        } else {
            self.InternetConnectionNotAvailable()
        }
    }
    func getPopularNewsData(_ requesturl: String?)
    {
        ...
        print("Popular News API URL : \(strDict)")
        ...
        { task, responseObject in if let responseObject = responseObject
            {
                print("Popular News Responce Data : \(responseObject)")
                ...
                for i in 0..<storeArr.count {
                    ...
                    if (storeDict != nil) {
                        self.PopularArray.add(storeDict as Any)
                    }
                }
                print("PopularArray Count = \(self.PopularArray.count)")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let newsType : String? = (self.PopularArray.value(forKey: "news_type") as! NSArray).object(at: indexPath.section) as? String
        if (newsType == "video") {
            let videoID : String? = (self.PopularArray.value(forKey: "video_id") as! NSArray).object(at: indexPath.section) as? String
            strImgPath = String(format: "http://i3.ytimg.com/vi/%@/hqdefault.jpg", videoID!)
            cell.btnPlay?.isHidden = false
        } else {
            strImgPath = (self.PopularArray.value(forKey: "news_image_b") as! NSArray).object(at: indexPath.section) as? String
        ...
        cell.lblNewsTitle?.text = (self.PopularArray.value(forKey: "news_title") as! NSArray).object(at: indexPath.section) as? String
        cell.lblDate?.text = (self.PopularArray.value(forKey: "news_date") as! NSArray).object(at: indexPath.section) as? String
        cell.lblViews?.text = (self.PopularArray.value(forKey: "news_views") as! NSArray).object(at: indexPath.section) as? String
        ...
        DispatchQueue.main.async {
            let htmlDesc = (self.PopularArray.value(forKey: "news_description") as! NSArray).object(at: indexPath.section) as? String
        ...
        modalObj.id = ((self.PopularArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let newsID : String = ((self.PopularArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let video_id : String = ((self.PopularArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let modalObj: Modal = Modal()
        modalObj.id = ((self.PopularArray.value(forKey: "id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cid = ((self.PopularArray.value(forKey: "cid") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.category_name = ((self.PopularArray.value(forKey: "category_name") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cat_id = ((self.PopularArray.value(forKey: "cat_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_type = ((self.PopularArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_title  = ((self.PopularArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_url = ((self.PopularArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_id = ((self.PopularArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_b = ((self.PopularArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_s = ((self.PopularArray.value(forKey: "news_image_s") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_description = ((self.PopularArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_date = ((self.PopularArray.value(forKey: "news_date") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_views = ((self.PopularArray.value(forKey: "news_views") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let news_title = (self.PopularArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!)
        let news_image_b = (self.PopularArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!)
        let news_description = (self.PopularArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!)
        let news_type : String = (self.PopularArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as! String
        let video_id = (self.PopularArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!)
        let video_url = (self.PopularArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!)
    ...
    override func viewDidLayoutSubviews()
    {
        ...
        //4.Header Name
        self.lblheadername?.text = CommonMessage.MostViewedNews()
