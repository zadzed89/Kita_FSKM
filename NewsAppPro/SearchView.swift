...
class SearchView: UIViewController,UITableViewDelegate,UITableViewDataSource,GADBannerViewDelegate,GADInterstitialDelegate
{
    ...
    func getSearchNews()
    {
        if (Reachability.shared.isConnectedToNetwork()) {
            ...
            self.getSearchNewsData(encodedString)
        } else {
            self.InternetConnectionNotAvailable()
        }
    }
    func getSearchNewsData(_ requesturl: String?)
    {
        ...
        let dict = ["salt":salt, "sign":sign, "method_name":"get_search_news", "search":searchTEXT]
        let data = CommonUtils.getBase64EncodedString(dict as [AnyHashable : Any])
        let strDict = ["data": data]
        print("Search News API URL : \(strDict)")
        ...
        { task, responseObject in if let responseObject = responseObject
            {
                print("Search News Responce Data : \(responseObject)")
                ...
                for i in 0..<storeArr.count {
                    ...
                    if (storeDict != nil) {
                        self.SearchArray.add(storeDict as Any)
                    }
                }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let newsType : String? = (self.SearchArray.value(forKey: "news_type") as! NSArray).object(at: indexPath.section) as? String
        if (newsType == "video") {
            let videoID : String? = (self.SearchArray.value(forKey: "video_id") as! NSArray).object(at: indexPath.section) as? String
            strImgPath = String(format: "http://i3.ytimg.com/vi/%@/hqdefault.jpg", videoID!)
            cell.btnPlay?.isHidden = false
        } else {
            strImgPath = (self.SearchArray.value(forKey: "news_image_b") as! NSArray).object(at: indexPath.section) as? String
        ...
        cell.lblNewsTitle?.text = (self.SearchArray.value(forKey: "news_title") as! NSArray).object(at: indexPath.section) as? String
        cell.lblDate?.text = (self.SearchArray.value(forKey: "news_date") as! NSArray).object(at: indexPath.section) as? String
        cell.lblViews?.text = (self.SearchArray.value(forKey: "news_views") as! NSArray).object(at: indexPath.section) as? String
        ...
        DispatchQueue.main.async {
            let htmlDesc = (self.SearchArray.value(forKey: "news_description") as! NSArray).object(at: indexPath.section) as? String
        ...
        modalObj.id = ((self.SearchArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let newsID : String = ((self.SearchArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let video_id : String = ((self.SearchArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let modalObj: Modal = Modal()
        modalObj.id = ((self.SearchArray.value(forKey: "id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cid = ((self.SearchArray.value(forKey: "cid") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.category_name = ((self.SearchArray.value(forKey: "category_name") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cat_id = ((self.SearchArray.value(forKey: "cat_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_type = ((self.SearchArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_title  = ((self.SearchArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_url = ((self.SearchArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_id = ((self.SearchArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_b = ((self.SearchArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_s = ((self.SearchArray.value(forKey: "news_image_s") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_description = ((self.SearchArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_date = ((self.SearchArray.value(forKey: "news_date") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_views = ((self.SearchArray.value(forKey: "news_views") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let news_title = (self.SearchArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!)
        let news_image_b = (self.SearchArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!)
        let news_description = (self.SearchArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!)
        let news_type : String = (self.SearchArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as! String
        let video_id = (self.SearchArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!)
        let video_url = (self.SearchArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!)
    ...
    override func viewDidLayoutSubviews()
    {
        ...
        //4.Header Name
        let searchTEXT : String = UserDefaults.standard.string(forKey: "SEARCH_TEXT")!
        self.lblheadername?.text = searchTEXT
