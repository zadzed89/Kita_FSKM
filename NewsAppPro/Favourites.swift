...
class Favourites: UIViewController,UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,GADBannerViewDelegate,GADInterstitialDelegate
{
    ...
    func getAllNewsData()
    {
        ...
        if (resultSet != nil)
        {
            while resultSet.next()
            {
                ...
                let cat_id = resultSet.string(forColumn: "cat_id")
                let news_type = resultSet.string(forColumn: "news_type")
                let news_title = resultSet.string(forColumn: "news_title")
                let video_url = resultSet.string(forColumn: "video_url")
                let video_id = resultSet.string(forColumn: "video_id")
                let news_image_b = resultSet.string(forColumn: "news_image_b")
                let news_image_s = resultSet.string(forColumn: "news_image_s")
                let news_description = resultSet.string(forColumn: "news_description")
                let news_date = resultSet.string(forColumn: "news_date")
                let news_views = resultSet.string(forColumn: "news_views")
                let cid = resultSet.string(forColumn: "cid")
                let category_name = resultSet.string(forColumn: "category_name")
                //FavouriteArray.add(newsInfo)
                let dict : NSDictionary = [
                    "id" : id as Any,
                    "cat_id" : cat_id as Any,
                    "news_type" : news_type as Any,
                    "news_title" : news_title as Any,
                    "video_url" : video_url as Any,
                    "video_id" : video_id as Any,
                    "news_image_b" : news_image_b as Any,
                    "news_image_s" : news_image_s as Any,
                    "news_description" : news_description as Any,
                    "news_date" : news_date as Any,
                    "news_views" : news_views as Any,
                    "cid" : cid as Any,
                    "category_name" : category_name as Any
                ]
                self.FavouriteArray.add(dict)
            }
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let newsType : String? = (self.FavouriteArray.value(forKey: "news_type") as! NSArray).object(at: indexPath.section) as? String
        if (newsType == "video") {
            let videoID : String? = (self.FavouriteArray.value(forKey: "video_id") as! NSArray).object(at: indexPath.section) as? String
            strImgPath = String(format: "http://i3.ytimg.com/vi/%@/hqdefault.jpg", videoID!)
            cell.btnPlay?.isHidden = false
        } else {
            strImgPath = (self.FavouriteArray.value(forKey: "news_image_b") as! NSArray).object(at: indexPath.section) as? String
        ...
        cell.lblNewsTitle?.text = (self.FavouriteArray.value(forKey: "news_title") as! NSArray).object(at: indexPath.section) as? String
        cell.lblDate?.text = (self.FavouriteArray.value(forKey: "news_date") as! NSArray).object(at: indexPath.section) as? String
        cell.lblViews?.text = (self.FavouriteArray.value(forKey: "news_views") as! NSArray).object(at: indexPath.section) as? String
        ...
        DispatchQueue.main.async {
            let htmlDesc = (self.FavouriteArray.value(forKey: "news_description") as! NSArray).object(at: indexPath.section) as? String
        ...
        modalObj.id = ((self.FavouriteArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let newsID : String = ((self.FavouriteArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let video_id : String = ((self.FavouriteArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let modalObj: Modal = Modal()
        modalObj.id = ((self.FavouriteArray.value(forKey: "id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cid = ((self.FavouriteArray.value(forKey: "cid") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.category_name = ((self.FavouriteArray.value(forKey: "category_name") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cat_id = ((self.FavouriteArray.value(forKey: "cat_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_type = ((self.FavouriteArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_title  = ((self.FavouriteArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_url = ((self.FavouriteArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_id = ((self.FavouriteArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_b = ((self.FavouriteArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_s = ((self.FavouriteArray.value(forKey: "news_image_s") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_description = ((self.FavouriteArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_date = ((self.FavouriteArray.value(forKey: "news_date") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_views = ((self.FavouriteArray.value(forKey: "news_views") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let news_title = (self.FavouriteArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!)
        let news_image_b = (self.FavouriteArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!)
        let news_description = (self.FavouriteArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!)
        let news_type : String = (self.FavouriteArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as! String
        let video_id = (self.FavouriteArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!)
        let video_url = (self.FavouriteArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!)
    ...
    override func viewDidLayoutSubviews()
    {
        ...
        //4.Header Name
        self.lblheadername?.text = CommonMessage.Favourites()
