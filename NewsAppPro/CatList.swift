...
class CatList: UIViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,GADBannerViewDelegate,GADInterstitialDelegate
{
    ...
    var CatListArray = NSMutableArray()
    ...
    override func viewDidLoad()
    {
        ...
        //========Get All Categories=======//
        self.CategoryArray = UserDefaults.standard.array(forKey: "CATEGORY_ARRAY")! as NSArray
        print("CategoryArray Count = \(self.CategoryArray.count)")
        
        //=========Set Header Category Name=========//
        let catNAME : String = UserDefaults.standard.string(forKey: "catNAME")!
        self.lblheadername?.text = catNAME
        
        //======Get Category wise List Data======//
        self.myTableView?.isHidden = true
        self.getCategoryListNews()
    }
    
    //===========Get Category wise List News Data==========//
    func getCategoryListNews()
    {
        if (Reachability.shared.isConnectedToNetwork()) {
            ...
            self.getCategoryListVideosData(encodedString)
        } else {
            self.InternetConnectionNotAvailable()
        }
    }
    func getCategoryListVideosData(_ requesturl: String?)
    {
        let catID : String = UserDefaults.standard.string(forKey: "catID")!
        let salt:String = CommonUtils.getSalt() as String
        let sign = CommonUtils.getSign(salt)
        let dict = ["salt":salt, "sign":sign, "method_name":"get_news_by_cat_id", "cat_id":catID]
        let data = CommonUtils.getBase64EncodedString(dict as [AnyHashable : Any])
        let strDict = ["data": data]
        print("Category wise List News API URL : \(strDict)")
        ...
        { task, responseObject in if let responseObject = responseObject
            {
                print("Category wise List News Responce Data : \(responseObject)")
                self.CatListArray.removeAllObjects()
                ...
                for i in 0..<storeArr.count {
                    ...
                    if storeDict != nil {
                        self.CatListArray.add(storeDict as Any)
                    }
                }
                print("CatListArray Count = \(self.CatListArray.count)")
    ...
    {
        return self.CatListArray.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let newsType : String? = (self.CatListArray.value(forKey: "news_type") as! NSArray).object(at: indexPath.section) as? String
        if (newsType == "video") {
            let videoID : String? = (self.CatListArray.value(forKey: "video_id") as! NSArray).object(at: indexPath.section) as? String
            strImgPath = String(format: "http://i3.ytimg.com/vi/%@/hqdefault.jpg", videoID!)
            cell.btnPlay?.isHidden = false
        } else {
            strImgPath = (self.CatListArray.value(forKey: "news_image_b") as! NSArray).object(at: indexPath.section) as? String
        ...
        cell.lblNewsTitle?.text = (self.CatListArray.value(forKey: "news_title") as! NSArray).object(at: indexPath.section) as? String
        cell.lblDate?.text = (self.CatListArray.value(forKey: "news_date") as! NSArray).object(at: indexPath.section) as? String
        cell.lblViews?.text = (self.CatListArray.value(forKey: "news_views") as! NSArray).object(at: indexPath.section) as? String
        ...
        DispatchQueue.main.async {
            let htmlDesc = (self.CatListArray.value(forKey: "news_description") as! NSArray).object(at: indexPath.section) as? String
        ...
        modalObj.id = ((self.CatListArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let newsID : String = ((self.CatListArray.value(forKey: "id") as! NSArray).object(at: indexPath.section) as? String)!
    ...
    {
        let video_id : String = ((self.CatListArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let modalObj: Modal = Modal()
        modalObj.id = ((self.CatListArray.value(forKey: "id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cid = ((self.CatListArray.value(forKey: "cid") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.category_name = ((self.CatListArray.value(forKey: "category_name") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.cat_id = ((self.CatListArray.value(forKey: "cat_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_type = ((self.CatListArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_title  = ((self.CatListArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_url = ((self.CatListArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.video_id = ((self.CatListArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_b = ((self.CatListArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_image_s = ((self.CatListArray.value(forKey: "news_image_s") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_description = ((self.CatListArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_date = ((self.CatListArray.value(forKey: "news_date") as! NSArray).object(at: (sender?.tag)!) as? String)!
        modalObj.news_views = ((self.CatListArray.value(forKey: "news_views") as! NSArray).object(at: (sender?.tag)!) as? String)!
    ...
    {
        let news_title = (self.CatListArray.value(forKey: "news_title") as! NSArray).object(at: (sender?.tag)!)
        let news_image_b = (self.CatListArray.value(forKey: "news_image_b") as! NSArray).object(at: (sender?.tag)!)
        let news_description = (self.CatListArray.value(forKey: "news_description") as! NSArray).object(at: (sender?.tag)!)
        let news_type : String = (self.CatListArray.value(forKey: "news_type") as! NSArray).object(at: (sender?.tag)!) as! String
        let video_id = (self.CatListArray.value(forKey: "video_id") as! NSArray).object(at: (sender?.tag)!)
        let video_url = (self.CatListArray.value(forKey: "video_url") as! NSArray).object(at: (sender?.tag)!)
